...
import com.xiaotu.gateway.constant.ZkPathConstants;
...
public class ZookeeperCacheManager implements CommandLineRunner, DisposableBean {
    ...
    public ZookeeperCacheManager(final ZkClient zkClient,ZkSerializer zkSerializer) {
    ...
    private void watcherPlugin(final String pluginName) {
        ...
        PluginZkDTO data = com.alibaba.fastjson.JSON.parseObject(zkClient.readData(pluginPath),PluginZkDTO.class);
    ...
    private void setSelectorData(final String realPath) {
    	 final SelectorZkDTO selectorZkDTO = com.alibaba.fastjson.JSON.parseObject(zkClient.readData(realPath),SelectorZkDTO.class);
    ...
    private void setRuleData(final String rulePath) {
    	final RuleZkDTO ruleZkDTO = com.alibaba.fastjson.JSON.parseObject(zkClient.readData(rulePath),RuleZkDTO.class);
    ...
    private void setAuthData(final String realPath) {
    	final AppAuthZkDTO appAuthZkDTO = com.alibaba.fastjson.JSON.parseObject(zkClient.readData(realPath),AppAuthZkDTO.class);
